...
class CustomSidebarViewProvider {
    ...
    resolveWebviewView(webviewView, context, token) {
        ...
        // default webview will show rock face 0
        webviewView.webview.html = this.getHtmlContent0(webviewView.webview);
        // This is called every second is decides which rock face to show in the webview
        setInterval(() => {
    ...
    getHtmlContent0(webview) {
        ...
        const face0 = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "rock0.gif"));
        return getHtml(face0);
    }
    // This is rock face 1
    getHtmlContent1(webview) {
        const stylesheetUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "main.css"));
        const face1 = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "rock1.gif"));
        return getHtml(face1);
    }
    // This is rock face 2
    getHtmlContent2(webview) {
        const stylesheetUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "main.css"));
        const face2 = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "rock2.gif"));
        return getHtml(face2);
    }
    // This is rock face 3
    getHtmlContent3(webview) {
        const stylesheetUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "main.css"));
        const face3 = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", "rock3.gif"));
        return getHtml(face3);
    }
}
CustomSidebarViewProvider.viewType = "rockface.openview";
